...
- Utilize CodeGraph to fetch only the method signatures (interfaces) needed for planning, and only retrieve full method bodies during the actual execution phase to drastically minimize token usage.
---
